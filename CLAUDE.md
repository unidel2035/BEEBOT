...
**При старте новой сессии разработки — читать:**
- [`docs/execution_prompt.md`](docs/execution_prompt.md) — алгоритм выполнения задач (8 шагов: тест → код → deploy)
- [`plan.md`](plan.md) — найти первую задачу без ✅ и объявить её Андрею
- [`analysis.md`](analysis.md) — контекст и риски

---

## Текущие возможности (production, 04.04.2026)
